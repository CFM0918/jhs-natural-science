...
{'html':'''<div class="eyebrow">核心 ③</h2><h2>pH 值：酸鹼的刻度</h2><div class="big-center"><svg viewBox="0 0 360 70" width="92%"><defs><linearGradient id="ph" x1="0" x2="1"><stop offset="0" stop-color="#e8000b"/><stop offset="0.5" stop-color="#7ac74f"/><stop offset="1" stop-color="#2a4bd0"/></linearGradient></defs><rect x="10" y="20" width="340" height="24" rx="4" fill="url(#ph)"/><text x="12" y="60" font-size="12" fill="#f4f1e8">0</text><text x="168" y="60" font-size="12" fill="#f4f1e8">7</text><text x="335" y="60" font-size="12" fill="#f4f1e8">14</text><text x="60" y="15" font-size="12" fill="#e8a0a0">酸性</text><text x="160" y="15" font-size="12" fill="#a8d0a0">中性</text><text x="285" y="15" font-size="12" fill="#9fc8d8">鹼性</text></svg></div><ul><li>pH < 7 <span class="hl-r">酸性</span>；= 7 中性；> 7 <span class="hl-b">鹼性</span></li><li>數字離 7 越遠，酸/鹼性越強</li></ul>'''},
{'html':'''<div class="eyebrow">例題 ★☆☆</h2><h2>先熱身</h2><div class="eg"><div class="q">pH=3、pH=6、pH=10 哪個酸性最強？</div></div><div class="box y">pH 越小越酸 → <span class="hl-r">pH=3</span> 酸性最強；pH=10 為鹼性。</div>'''},
{'html':'''<div class="eyebrow">實驗觀察</h2><h2>中和的溫度變化</h2><ul><li>酸與鹼混合後，溫度<span class="hl-r">上升</span></li><li>證明中和是<span class="hl-r">放熱反應</span></li><li>可用指示劑觀察酸鹼性消長</li></ul><div class="box y">H⁺ 與 OH⁻ 結合成水時釋出能量。</div>'''},
{'html':'''<div class="eyebrow">例題 ★★☆</h2><h2>試試看</h2><div class="eg"><div class="q">鹽酸與氫氧化鈉恰好完全中和，產物是？溶液 pH 約？</div></div><div class="box y"><p style="margin:0;">產物：<span class="hl">氯化鈉 NaCl + 水</span></p><p style="margin:6px 0 0;">恰好中和 → pH ≈ <span class="hl">7</span></p></div>'''},
{'html':'''<div class="eyebrow">觀念釐清</h2><h2>中和後一定是中性嗎？</h2><div class="box r">不一定！</div><ul><li>酸過量 → 溶液仍<span class="hl-r">偏酸</span></li><li>鹼過量 → 溶液仍<span class="hl-b">偏鹼</span></li><li>恰好中和才會中性(pH≈7)</li></ul>'''},
{'html':'''<div class="eyebrow">素養 · 生活 ①</h2><h2>胃藥中和胃酸</h2><ul><li>胃酸過多引起不適</li><li>吃<span class="hl-b">鹼性</span>胃藥中和過多 H⁺</li></ul><div class="box y">中和不是只在實驗室，也在你的胃裡發生。</div>'''},
{'html':'''<div class="eyebrow">素養 · 生活 ②</h2><h2>更多中和應用</h2><table class="tbl"><tr><th>情境</th><th>原理</th></tr><tr><td>酸性土壤撒石灰</td><td>鹼中和酸</td></tr><tr><td>蜂螫(酸)塗小蘇打</td><td>鹼中和酸</td></tr><tr><td>牙膏偏鹼</td><td>中和口腔酸</td></tr></table>'''},
{'html':'''<div class="eyebrow">例題 ★★★</h2><h2>綜合判斷</h2><div class="eg"><div class="q">在鹼性溶液中持續加入鹽酸，pH 會如何變化？</div></div><div class="box y">pH 由大(鹼)逐漸<span class="hl-r">下降</span>，過中性(7)後若酸過量則 < 7 呈酸性。</div>'''},
{'html':'''<div class="eyebrow">課綱提醒</h2><h2>國中範圍</h2><div class="box">認識 pH 的<span class="hl">意義</span>與酸鹼判斷</div><div class="box r">不涉及 pH 的<span class="hl-r">計算</span>（移高中）</div><div class="box-b">不涉莫耳濃度、稀釋計算（移高中）</div>'''},
{'html':'''<div class="eyebrow">本節總結</h2><h2>三句話記住</h2><div class="box"><span class="hl">中和：</span>酸+鹼→鹽+水，H⁺+OH⁻→H₂O，放熱</div><div class="box-b"><span class="hl-b">pH：</span><7酸、=7中、>7鹼，離7越遠越強</div><div class="box r"><span class="hl-r">應用：</span>胃藥、石灰改良土壤、牙膏</div>'''},
