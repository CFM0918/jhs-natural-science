...
'quiz':{
'基礎卷':[
 ('酸與鹼反應生成？','鹽和水','中和：酸和鹼混合時會互相抵消對方的性質，反應後產生鹽和水這兩種新物質'),
 ('中和反應的離子式核心是？','H⁺+OH⁻→H₂O','結合：酸提供的氫離子和鹼提供的氫氧根離子結合在一起，就形成了普通的水分子'),
 ('中和是放熱還吸熱？','放熱','升溫：氫離子和氫氧根結合成水的過程會釋放出能量，所以中和時溶液溫度會上升'),
 ('pH小於7是？','酸性','偏酸：pH值用來表示酸鹼程度，數字比7小就代表這杯溶液偏酸性'),
 ('pH等於7是？','中性','純水：pH值剛好等於7表示這杯溶液既不偏酸也不偏鹼，像純水就是中性的例子'),
 ('pH大於7是？','鹼性','偏鹼：pH值用來表示酸鹼程度，數字比7大就代表這杯溶液偏鹼性'),
 ('食鹽是一種？','鹽','NaCl：食鹽的化學名稱是氯化鈉，是鹽酸和氫氧化鈉中和之後會產生的一種鹽類'),
 ('胃藥的作用是中和？','胃酸','過多酸：胃酸過多會讓人不舒服，胃藥中含有鹼性成分能把多餘的胃酸中和掉，緩解不適'),
],
'進階卷':[
 ('鹽酸與氫氧化鈉中和生成？','氯化鈉和水','NaCl+H₂O：鹽酸提供的氫離子和氫氧化鈉提供的氫氧根結合成水，剩下的鈉和氯結合成氯化鈉'),
 ('中和反應溫度如何變？','上升','放熱：中和反應會釋放能量到溶液中，所以反應進行時可以觀察到溫度計的讀數逐漸上升'),
 ('pH=3和pH=5誰較酸？','pH=3','數字小：pH值越小代表溶液越偏酸性，所以pH等於3的溶液比pH等於5的溶液酸性更強'),
 ('酸性土壤可用什麼改良？','石灰(鹼性)','中和：石灰是鹼性物質，撒進酸性土壤中可以中和土壤裡過多的酸，改善土壤品質'),
 ('中和後溶液一定中性嗎？','不一定','視量與強弱：如果酸和鹼的量沒有恰好相等，反應後多出來的那一方會讓溶液仍然偏酸或偏鹼'),
 ('鹽多屬哪類化合物？','離子化合物','導電：鹽類大多是由帶正電和帶負電的離子組成，溶於水後能拆出離子，所以能導電'),
 ('牙膏偏鹼是為了？','中和口腔酸','護齒：口腔中的細菌會產生酸性物質腐蝕牙齒，牙膏做成鹼性可以中和這些酸，保護牙齒'),
 ('pH=7的液體是？','中性','如純水：pH值剛好是7，代表這種液體既不偏酸也不偏鹼，純水就是典型的中性液體'),
],
'挑戰卷':[
 ('胃酸過多吃鹼性胃藥原理？','鹼中和過多H⁺減緩不適','中和：鹼性胃藥中的成分會和胃裡多餘的氫離子結合，降低胃酸濃度，讓不舒服的感覺減緩'),
 ('中和反應為何放熱？','H⁺與OH⁻結合成水釋出能量','機制：氫離子和氫氧根離子結合成穩定的水分子時，會把多餘的能量以熱的形式釋放出來'),
 ('等量強酸強鹼中和後pH約？','7(中性)','恰中和：強酸和強鹼的量剛好相等時會完全反應完，沒有誰過量，所以溶液會呈現中性pH約為7'),
 ('過量酸與少量鹼中和後呈？','酸性','酸剩餘：鹼的量不夠把所有的酸都反應完，所以反應後溶液裡還剩下多餘的酸，整體呈酸性'),
 ('為何蜂螫(酸性)可塗小蘇打？','鹼性中和酸','緩解：蜂螫注入的毒液偏酸性，小蘇打是鹼性物質，塗上去可以中和酸性毒液，減輕刺痛感'),
 ('如何用指示劑觀察中和終點？','顏色改變時','終點：滴入指示劑後持續加入另一種試劑，當溶液顏色突然改變的那一刻，就代表酸鹼剛好中和完'),
 ('鹽類命名由酸鹼決定,鹽酸+NaOH得？','氯化鈉','命名：鹽酸裡的氯和氫氧化鈉裡的鈉結合，依照命名規則就會產生氯化鈉這種鹽'),
 ('為何國中不算pH值？','移高中,國中重意義','課綱：pH值背後牽涉到較複雜的計算方式，這部分留到高中再學，國中先了解pH代表的意義就好'),
],
},
}
